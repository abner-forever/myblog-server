...
exports.acticleList = (pageNum, pageSize) => {
    let _sql = `SELECT title,id,userName,createTime,updateTime,description
     FROM user right join blog_article 
     on user.userId = blog_article.userId 
    >= (
    SELECT id FROM user right
    join blog_article on user.userId = blog_article.userId
...
exports.geArticleById = (value) => {
    ...
    blog_article on user.userId = blog_article.userId 
