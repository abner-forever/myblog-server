...
exports.acticleList = (pageNum, pageSize) => {
    ...
    unix_timestamp(create_time)*1000 as createName, 
...
exports.addArticle = ({ title, description, content, userId }) => {
    ...
    let _sql = `INSERT INTO article (title, userName, userId, description, content, type ,viewCount, likeCount, hot, createTime, updateTime) VALUES ( '${title}', NULL, ${userId}, '${_description}', '${_content}', NULL, NULL,  NULL, NULL, NOW(), NOW());`
